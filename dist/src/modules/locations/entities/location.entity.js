...
class LocationEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, address: { required: true, type: () => String }, image: { required: true, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)(),
    __metadata("design:type", String)
], LocationEntity.prototype, "image", void 0);
