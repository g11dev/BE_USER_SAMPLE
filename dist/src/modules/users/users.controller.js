...
let UsersController = class UsersController {
    ...
    async findAll(params) {
        return await await this.usersService.findAll(params);
    }
    async findOne(email) {
        return await await this.usersService.findOne({ email });
    }
    async update(id, updateUserDto) {
        return await await this.usersService.update(id, updateUserDto);
    }
    async remove(id) {
